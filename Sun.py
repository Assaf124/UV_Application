...
class Sun:
    ...
    def get_sunrise_time(self, latitude, longitude):
        return self.calc_sun_time(latitude, longitude, True)

    def get_sunset_time(self, latitude, longitude):
        return self.calc_sun_time(latitude, longitude, False)

    def get_current_UTC(self):
        now = datetime.datetime.now()
        return [now.day, now.month, now.year]

    def calc_sun_time(self, latitude, longitude, isRiseTime, zenith=90.8):
