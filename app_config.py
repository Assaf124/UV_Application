...
ALT_COORDINATES_FILE_NAME = 'coordinates_new.json'  # del
COORDINATES_FILE_PATH = os.path.join(APPLICATION_MAIN_PATH, COORDINATES_DIR_NAME, COORDINATES_FILE_NAME)
ALT_COORDINATES_FILE_PATH = os.path.join(APPLICATION_MAIN_PATH, COORDINATES_DIR_NAME, ALT_COORDINATES_FILE_NAME) # del
