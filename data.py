...
def get_uv_risk(latitude, longitude, *args):
    ...
    Returns:
        uv_list:        list of uv exposure time in accordance with skin type
...
def get_cloud_coverage(latitude, longitude, token, *args):
    ...
    Returns:
        cloudCover: cloud coverage value in % units
        solar:      sun solar flux value
